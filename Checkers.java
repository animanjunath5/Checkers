	...
	public static void main(String[] args) {
		...
		while (!abSearch.game.isTerminal(board)) {
			...
			if (board.isHumanTurn()) {
				...
				// Change player's turn after multiple jumps complete
